...
export type PreferenceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value", ExtArgs["result"]["preference"]>
...
export interface PreferenceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const preferenceWithKeyOnly = await prisma.preference.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Preferences and only return the `key`
   * const preferenceWithKeyOnly = await prisma.preference.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Preferences and only return the `key`
   * const preferenceWithKeyOnly = await prisma.preference.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
